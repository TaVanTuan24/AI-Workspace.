...
const envSchema = z.object({
  ...
  SESSION_BLOB_ROOT: z.string().default(".data/session-blobs"),
  ...
  RETENTION_CLEANUP_SCHEDULER_ENABLED: z.coerce.boolean().default(false),
  RETENTION_CLEANUP_INTERVAL_SECONDS: z.coerce.number().int().positive().default(86_400),
  RETENTION_CLEANUP_LOCK_TTL_SECONDS: z.coerce.number().int().positive().default(3_600),
