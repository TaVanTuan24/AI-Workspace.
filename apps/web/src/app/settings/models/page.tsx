...
export default function ModelPreferencesPage() {
  ...
  async function loadData() {
    try {
      setLoading(true);
      setError("");
      const [res, liveRes, overviewRes] = await Promise.all([
        apiGetModelPreferences(),
  ...
  const canWriteDiagnostics = hasPermission(permissions, "providerDiagnostics.action");
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <button
          onClick={handleSave}
          disabled={loading || saving || !canWriteModels}
                    ...
                    <td className="p-4 text-right">
                      <div className="flex items-center justify-end gap-2 flex-wrap max-w-[150px] ml-auto">
                        <button
                          ...
                          disabled={detecting[model.provider] || model.requiresLogin || !canWriteModels}
                        ...
                        <button
                          ...
                          disabled={refreshing[model.provider] || !canWriteDiagnostics}
