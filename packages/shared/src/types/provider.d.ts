...
export type JobStatus = "queued" | "running" | "streaming" | "completed" | "failed" | "cancelled" | "timeout" | "requires_login" | "manual_action_required";
export type ChatJobStatus = JobStatus;
export type ErrorCode = "UNKNOWN_PROVIDER" | "PROVIDER_NOT_READY" | "PROVIDER_NOT_CONNECTED" | "PROVIDER_BUSY" | "JOB_NOT_FOUND" | "JOB_FORBIDDEN" | "JOB_NOT_CANCELLABLE" | "JOB_NOT_RETRYABLE" | "JOB_CANCELLED" | "JOB_TIMEOUT" | "WORKER_UNAVAILABLE" | "SESSION_EXPIRED" | "REQUIRES_LOGIN" | "MANUAL_ACTION_REQUIRED" | "PROVIDER_RATE_LIMITED" | "PROVIDER_RATE_LIMIT_EXCEEDED" | "PROVIDER_TIMEOUT" | "PROVIDER_UI_CHANGED" | "BROWSER_CONTEXT_FAILED" | "SESSION_DECRYPT_FAILED" | "SESSION_ENCRYPT_FAILED" | "INVALID_PROVIDER" | "CONCURRENCY_LOCKED" | "CHAT_JOB_FAILED" | "UNKNOWN_SAFE_ERROR";
export type ProviderCapability = "connect" | "validate_session" | "send_message" | "pseudo_stream" | "multi_provider";
export type ProviderReadiness = "ready" | "connect_only" | "not_implemented" | "disabled";
...
export interface WorkspaceNotification {
    ...
    kind: "provider_requires_login" | "provider_expired" | "provider_manual_action" | "provider_ui_changed" | "provider_unusable" | "no_usable_models" | "provider_limit_spike" | "test_webhook";
    title: string;
    message: string;
    provider?: ProviderId;
    modelId?: string;
...
export type NotificationDeliveryChannel = "in_app" | "email_noop" | "slack_noop" | "webhook_noop" | "webhook";
export type NotificationDeliveryStatus = "delivered" | "skipped_disabled" | "skipped_not_configured" | "failed";
